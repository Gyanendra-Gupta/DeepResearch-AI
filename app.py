...
# ── Page config ──────────────────────────────────────────────────────────────
st.set_page_config(
    page_title="DeepResearch AI Research Agent",
    page_icon="🔬",
    layout="wide",
...
# ... (rest of the file remains unchanged until line 410)
...
if st.session_state.running and not st.session_state.done:
    ...
    with st.spinner("🔍  Search Agent is working…"):
        ...
        # Added type ignore to satisfy Pylance's strict TypedDict check
        sr = search_agent.invoke({ # type: ignore
    ...
    with st.spinner("📄  Reader Agent is scraping top resources…"):
        ...
        # Added type ignore to satisfy Pylance's strict TypedDict check
        rr = reader_agent.invoke({ # type: ignore
            "messages": [("user",
